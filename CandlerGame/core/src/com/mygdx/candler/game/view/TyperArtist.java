...
public class TyperArtist implements TypingProcessor {
    ...
    Timer timer;
    public TyperArtist(Stage stage, FileReader fileReader, int countdown) {
        timer=new Timer(stage, countdown);
        this.stage=stage;
        font = new BitmapFont();
    ...
    public TyperArtist(Stage stage, ArrayList<String>possibleSentences,int countdown) {
        timer=new Timer(stage, countdown);
        this.stage=stage;
        font = new BitmapFont();
        sentenceDrawers=new ArrayList<>();
